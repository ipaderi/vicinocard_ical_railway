...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://ical.vicinocard.com";
...
export const HOSTED_CAL_FEATURES = process.env.HOSTED_CAL_FEATURES || BASE_URL === "https://ical.vicinocard.com";
/** @deprecated use `WEBAPP_URL` */
